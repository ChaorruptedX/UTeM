...
public class OrderServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int code = Integer.parseInt(request.getParameter("selectedProduct"));
		int quantity = Integer.parseInt(request.getParameter("specifiedQuantity"));
		...
		writer.print("Price per quantity: RM " + String.format("%.2f", price) + "<br>");
		writer.print("Quantity: " + quantity + "<br><br>");
		writer.print("<b>Total Amount: RM " + String.format("%.2f", total) + "</b><br>");
		writer.print("Service total: RM " + String.format("%.2f", serviceTax) + "<br>");
		writer.print("Amount before tax: RM " + String.format("%.2f", subTotal) + "<br></html>");
	}
